...
psql -h $HOST_NAME -p $PORT -U $USER -d $DATABASE_NAME -f "./OMOP CDM constraints - PostgreSQL.sql" -q
printf "\nApplying indices...\n"
psql -h $HOST_NAME -p $PORT -U $USER -d $DATABASE_NAME -f "./OMOP CDM indexes required - PostgreSQL.sql"
